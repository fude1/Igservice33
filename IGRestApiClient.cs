...
namespace IGConnect
{
    public partial class IgRestApiClient
    {
        ...
        public IgRestApiClient(string environmentr)
        {
            this._igRestService = new IgRestService(environmentr);
        }
        ...
        public async Task<IgResponse<Application1>> update(UpdateApplicationRequest updateApplicationRequest)
        {
            return await _igRestService.RestfulService<Application1>("/gateway/deal/operations/application", HttpMethod.Put, "1", _conversationContext, updateApplicationRequest);
        }
        ...
        public async Task<IgResponse<Application1>> disableApplication()
        {
            return await _igRestService.RestfulService<Application1>("/gateway/deal/operations/application/disable", HttpMethod.Put, "1", _conversationContext);
        }
        ...
        public async Task<IgResponse<List<Application1>>> findClientApplications()
        {
            return await _igRestService.RestfulService<List<Application1>>("/gateway/deal/operations/application", HttpMethod.Get, "1", _conversationContext);
        }
